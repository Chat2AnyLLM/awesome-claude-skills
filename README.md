...
| [ArieGoldkin/claude-forge](https://github.com/ArieGoldkin/claude-forge) | 112 | `main` | `.` | ✅ ok |  |
...
| [andresnator/agents-orchestrator](https://github.com/andresnator/agents-orchestrator) | 0 | `main` | `skills` | ❌ missing | HTTP 404 |
